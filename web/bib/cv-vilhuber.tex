...
\begin{itemize}
	\item ``Workshop on Transparency and Reproducibility in Federal Statistics'' (presentation in June 2017, workshop report see \cite{NAP25305})
	\item ``Committee on Reproducibility and Replicability in Science'' (white paper prepared July 2018, final report pending 2019)
\end{itemize}
